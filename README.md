...
* `-y, --year <integer>` - Year of the puzzle. Default value can be defined using `mix aoc.set`, otherwise uses today's year.
* `-d, --day <integer>` - Day of the puzzle. Default value can be defined using `mix aoc.set`, otherwise uses today's day.
